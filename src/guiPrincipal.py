...
class Ui_MainWindow(QMainWindow):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(862, 715)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 861, 661))
        font = QtGui.QFont()
        ...
        self.line_4.setGeometry(QtCore.QRect(40, 450, 771, 20))
        ...
        self.preOutput = QtWidgets.QPlainTextEdit(self.tab)
        self.preOutput.setGeometry(QtCore.QRect(40, 500, 781, 111))
        self.preOutput.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.preOutput.setReadOnly(True)
        self.preOutput.setPlainText("")
        self.preOutput.setObjectName("preOutput")
        self.widget = QtWidgets.QWidget(self.tab)
        self.widget.setGeometry(QtCore.QRect(530, 170, 201, 65))
        ...
        self.input_duty = QtWidgets.QLineEdit(self.widget)
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.label_Vo_2 = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.line.setGeometry(QtCore.QRect(410, 290, 431, 20))
        ...
        self.line_2.setGeometry(QtCore.QRect(10, 110, 831, 20))
        ...
        self.controllerOutput.setGeometry(QtCore.QRect(40, 500, 781, 111))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(550, 220, 261, 69))
        ...
        self.customCNum = QtWidgets.QLineEdit(self.layoutWidget1)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_C_2 = QtWidgets.QLabel(self.layoutWidget1)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.customCDen = QtWidgets.QLineEdit(self.layoutWidget1)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.textSpeed = QtWidgets.QLineEdit(self.layoutWidget2)
        self.textSpeed.setObjectName("textSpeed")
        self.gridLayout_4.addWidget(self.textSpeed, 1, 1, 1, 1)
        self.labelRapido_4 = QtWidgets.QLabel(self.layoutWidget2)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.labelRapido_2 = QtWidgets.QLabel(self.layoutWidget2)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.textFreq = QtWidgets.QLineEdit(self.layoutWidget2)
        self.textFreq.setObjectName("textFreq")
        self.gridLayout_4.addWidget(self.textFreq, 2, 1, 1, 1)
        self.labelRapido_3 = QtWidgets.QLabel(self.layoutWidget2)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_9.setGeometry(QtCore.QRect(340, 60, 241, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_9.setFont(font)
        self.label_9.setObjectName("label_9")
        self.line_7 = QtWidgets.QFrame(self.tab_3)
        self.line_7.setGeometry(QtCore.QRect(9, 189, 831, 20))
        ...
        self.line_8.setGeometry(QtCore.QRect(20, 440, 831, 20))
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(150, 130, 581, 30))
        self.layoutWidget3.setObjectName("layoutWidget3")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.layoutWidget3)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.label_ensaio_3 = QtWidgets.QLabel(self.layoutWidget3)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.bEnsaioMF = QtWidgets.QToolButton(self.layoutWidget3)
        self.bEnsaioMF.setObjectName("bEnsaioMF")
        self.gridLayout_3.addWidget(self.bEnsaioMF, 0, 1, 1, 1)
        self.ensaioMFText = QtWidgets.QLineEdit(self.layoutWidget3)
        ...
        self.MFOutput.setGeometry(QtCore.QRect(40, 500, 781, 111))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.input_Vo.setStatusTip(_translate("MainWindow", "Tensão de saída"))
        ...
        self.bTdPadrao.setStatusTip(_translate("MainWindow", "Função de transferência obtivo padrão"))
        ...
        self.bTdCustom.setStatusTip(_translate("MainWindow", "Função de transferência obtivo definido pelo usuário"))
        ...
        self.customCNum.setStatusTip(_translate("MainWindow", "Controlador customizado pelo usuário"))
        ...
        self.customCDen.setStatusTip(_translate("MainWindow", "Controlador customizado pelo usuário"))
        ...
        self.textAcom.setStatusTip(_translate("MainWindow", "Função de transferência obtivo padrão"))
        ...
        self.textSpeed.setStatusTip(_translate("MainWindow", "Função de transferência obtivo padrão"))
        ...
        self.textFreq.setStatusTip(_translate("MainWindow", "Função de transferência obtivo padrão"))
        ...
        self.grafTd.setStatusTip(_translate("MainWindow", "Gerar gráfico da T(z) da planta com o controlador projetado"))
        self.grafTd.setText(_translate("MainWindow", "Gerar Gráfico T(z)"))
        self.label_9.setText(_translate("MainWindow", "Dados da Malha Fechada"))
        ...
        self.bSensi.setStatusTip(_translate("MainWindow", "Estimar sensibilidade da planta"))
